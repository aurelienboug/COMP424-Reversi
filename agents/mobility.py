...
def heuristic(board, player, opponent):
    ...
    return mobility_score * 5 #+ parity_score * 35 + corners_score * 30 + stability_score * 25 + board_score * 15 + near_corner_penalty * 15
...
@register_agent("mobility")
class Mobility(Agent):
