...
@register_agent("stab2_equal")
class Stab2_equal(Agent):

    def __init__(self):
        super(Stab2_equal, self).__init__()
        self.name = "Stab2_equal"
    ...
    def step(self, board, player, opponent):
        ...
        """print("player_mobility_score", player_player_mobility,"opponent_mobility_score", opponent_player_mobility)
        print(f"Player {self.name}")
        print(f"parity : {parity_score:.4f}, corners : {corners_score:.4f}, stability: {stability_score:.4f}, mobility: {mobility_score:.4f}, near_corner: {near_corner_penalty:.4f}")
        print("score : ", heuristic(board, player, opponent))
        print("----------------------------------------------------------------------")"""
        return best_move
