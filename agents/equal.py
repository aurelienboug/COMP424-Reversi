...
def heuristic(board, player, opponent):
    ...
    return mobility_score + parity_score + corners_score + stability_score + board_score + near_corner_penalty
...
class Equal(Agent):
    ...
    def step(self, board, player, opponent):
        ...
        print(f"parity : {parity_score:.4f}, corners : {corners_score:.4f}, stability: {stability_score:.4f}, mobility: {mobility_score:.4f}, near_corner: {near_corner_penalty:.4f}, board_score: {board_score:.4f}")
